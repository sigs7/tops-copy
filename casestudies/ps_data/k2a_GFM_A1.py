    ...
    return {
        ...
        'vsc': {
            'VSC_PV': [
                ...
                ['PV1', 'B1',    900,   0.77,    1.03,    1,      1,   0.1,   0.1,     5,      1,      0.01,    1.2],
                ['PV2', 'B2',    900,   0.77,    1.02,    1,      1,   0.1,   0.1,     5,      1,      0.01,    1.2],
            ],
            # 'VSC_PQ': [
            #    ['name', 'bus', 'S_n', 'p_ref', 'q_ref',  'k_p', 'k_q', 'T_p', 'T_q', 'k_pll','T_pll', 'T_i', 'i_max'],
            #    ['PV1', 'B1',    900,     .77,       0,       1,      1,    0.1,   0.1,     5,      1,      0.01,    1.2],
            #    ['PV2', 'B2',    900,     .77,       0,       1,      1,    0.1,   0.1,     5,      1,      0.01,    1.2],
            # ],
            # 'UIC': [
            #     ['name', 'bus', 'S_n',      'V_n',      'p_ref', 'q_ref',   'Ki',   'xf'],
            #     ['UIC1', 'B1',    900,      1.03,     .77,      0.3,   0.03,    0.01],
            #     ['UIC2', 'B2',    900,      1.02,     .77,      0.3,   0.03,    0.01],
            # ],
        },
